...
print('Done')
print(F'number of unique words in vocab_set: {len(vocab_list)}')
...
print(F'\nNumber of <unk> words in vocabulary: {preprocessing.count_unk_words(intersection_words_idx, vocab_list)}')
...
print('saving final_embeddings_matrix')
